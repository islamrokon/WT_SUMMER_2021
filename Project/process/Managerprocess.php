<?php include('../view/Managerreg.php');
...
$userQuery=$connection->Addmanager($conobj,"manager",$email,$password,$fname,$lname,$bg,$gender,$DateofBirth,$phone,$address,$nid,$file2,$file,$filec);
if($userQuery==TRUE)
{
