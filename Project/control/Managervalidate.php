...
$phone="";
$address="";
$password=$validatenid=$nid=$validatenidimg="";
$bg="";
$flag=false;
...
if(move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)){
    ...
    echo "Please try to upload again your picture!<br>";
    $flag=FALSE;
}
...
if(move_uploaded_file($_FILES["filec"]["tmp_name"], $target_file)){
    ...
    echo "You have uploaded your Bachelor certificate<br>";
    $flag=TRUE;

}
else{
    echo "Please try to upload again your certificate!";
    $flag=FALSE;
}
